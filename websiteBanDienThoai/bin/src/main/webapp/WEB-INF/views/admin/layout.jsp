...
<!-- Bootstrap core CSS     -->
<link href="/static/assets-a/assets/css/bootstrap.min.css"
	rel="stylesheet" />
<!--  Material Dashboard CSS    -->
<link href="/static/assets-a/assets/css/material-dashboard.css"
	rel="stylesheet" />
<style>
...
<!-- add admin.... -->
<link rel="stylesheet" href="/static/assets-a/assets/css/Form.css">

<!--  script begin-->
<!--   Core JS Files   -->
<script src="/static/assets-a/assets/js/jquery-3.1.1.min.js"
	type="text/javascript"></script>
<script src="/static/assets-a/assets/js/jquery-ui.min.js"
	type="text/javascript"></script>
<script src="/static/assets-a/assets/js/bootstrap.min.js"
	type="text/javascript"></script>
<script src="/static/assets-a/assets/js/material.min.js"
	type="text/javascript"></script>
<script src="/static/assets-a/assets/js/perfect-scrollbar.jquery.min.js"
	type="text/javascript"></script>
